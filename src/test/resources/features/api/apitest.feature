  ...
  Scenario: Complete User CRUD Cycle
    ...
    When I send a POST request to create a new user with body:
      """
      {
        ...
        "gender": "male",
        "email": "dunkirk9876000@example.com",
        "dateOfBirth": "1977-05-14T14:44:52.955Z",
        "phone": "9115-990-2288",
        "location": {
    ...
    And the response field "firstName" should be "Stewart"
...
#    And the response field "data[0].firstName" should be "Charlotte"
    ...
    When I send a delete request for id "60d0fe4f5311236168a10a08"
    Then the API response status code should be 200
